...
def ind_sem(data):
    ...
    if sel=="sem-I":
        st.dataframe(data[["Sl.No","Roll.No","Student Name","I-I SGPA","I-I Credits","I-I Backlogs"]])
    if sel=="sem-II":
        st.dataframe(data[["Sl.No","Roll.No","Student Name","I-II SGPA","I-II Credits","I-II Backlogs"]])
    if sel=="sem-III":
        st.dataframe(data[["Sl.No","Roll.No","Student Name","II-I SGPA","II-I Credits","II-I Backlogs"]])
    if sel=="sem-IV":
        st.dataframe(data[["Sl.No","Roll.No","Student Name","II-II SGPA","II-II Credits","II-II Backlogs"]])
    if sel=="sem-V":
        st.dataframe(data[["Sl.No","Roll.No","Student Name","III-I SGPA","III-I Credits","III-I Backlogs"]])
    if sel=="sem-VI":
        st.dataframe(data[["Sl.No","Roll.No","Student Name","III-II SGPA","III-II Credits","III-II Backlogs"]])
    if sel=="sem-VII":
        st.dataframe(data[["Sl.No","Roll.No","Student Name","IV-I SGPA","IV-I Credits","IV-I Backlogs"]])
    if sel=="sem-VIII":
        st.dataframe(data[["Sl.No","Roll.No","Student Name","IV-II SGPA","IV-II Credits","IV-II Backlogs"]])
